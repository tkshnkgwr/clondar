...
| :--- | :--- | :--- | :--- | :---: |
| TS-001 | 起動時の位置復元 | 前回の終了位置（絶対物理座標）に正確に復帰すること。 | DPIスケール環境(125%/150%)を含め、完全に前回と同じ物理位置へ一貫して復帰することを確認。 | **PASS** |
...
---
**作成日**: 2026年6月18日
**適合バージョン**: Widget v1.2.0 (DPI-Aware Physical Coordination Model)
<br>
<!-- UPDATE 2026-06-18: END -->
